...
![](http://cdn.jswalk.com/server-deploy-img-01.png)
...
![](http://cdn.jswalk.com/server-deploy-img-02.png)

进来之后也许你看到的列表是空的，就像这样：

![](http://cdn.jswalk.com/server-deploy-img-03.png)

这可能是你所选的地区不对，看上面实例旁边的下拉框，这时候实例是广州，也许你买的是其他地区，切换一下：

![](http://cdn.jswalk.com/server-deploy-img-04.png)

我这边买的是上海，所以选择上海，你要选择的是你买的服务器地区。这时候就能看到你的服务器信息

![](http://cdn.jswalk.com/server-deploy-img-05.png)
...
![](http://cdn.jswalk.com/server-deploy-img-06.png)
...
2. 在搜索框里输入你喜欢的域名，点击查询，比如我的域名是 `jswalk`
   ![](http://cdn.jswalk.com/server-deploy-img-07.png)

   `jswalk.com` 已经被我注册过了你就不能注册了，你可以换一个后缀名，或者换一个名字

3. 选完之后点击 “加入购物车”，在右侧购物车里点击立即购买，跳到提交订单页面

   ![](http://cdn.jswalk.com/server-deploy-img-08.png)
...
![](http://cdn.jswalk.com/server-deploy-img-12.png)

进去后可以看到会有一个默认的安全组，点击 “修改规则”，就到了 “安全组规则” 界面，接下来就是配这里的规则

![](http://cdn.jswalk.com/server-deploy-img-13.png)
...
![](http://cdn.jswalk.com/server-deploy-img-14.png)
...
![](http://cdn.jswalk.com/server-deploy-img-15.png)
...
![](http://cdn.jswalk.com/server-deploy-img-16.png)
...
![](http://cdn.jswalk.com/server-deploy-img-17.png)

你可以在这里选择当前最新版，也可以点击 “全部安装包” 的 “阿里云镜像” 里找到想要的版本号

![](http://cdn.jswalk.com/server-deploy-img-18.png)
...
![](http://cdn.jswalk.com/server-deploy-img-19.png)
...
![](http://cdn.jswalk.com/server-deploy-img-20.png)
...
![](http://cdn.jswalk.com/server-deploy-img-21.png)
...
![](http://cdn.jswalk.com/server-deploy-img-22.png)
...
![](http://cdn.jswalk.com/server-deploy-img-23.png)
...
2. 在头部右侧有个加号，点击加号的第一个选项 "New repository" 创建新创库。
   ...
   ![](http://cdn.jswalk.com/server-deploy-img-24.png)

3. 填写 "Repositroy name" ，即填写仓库名称。如果有描述信息可以写下，不写也没事。

   ![](http://cdn.jswalk.com/server-deploy-img-25.png)
...
4. 后续登录服务器还需要用到一些变量信息：
   ...
   ![](http://cdn.jswalk.com/server-deploy-img-35.png)
...
![](http://cdn.jswalk.com/server-deploy-img-36.png)

页面跳转过去再点击左侧的 “发布和部署”，这时候在右侧就能看到进度了。

![](http://cdn.jswalk.com/server-deploy-img-37.png)

当全部任务都呈现打勾状态的时候，就代表部署完成了。

![](http://cdn.jswalk.com/server-deploy-img-38.png)
...
![](http://cdn.jswalk.com/server-deploy-img-39.png)
